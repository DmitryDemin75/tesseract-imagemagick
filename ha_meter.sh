...
#VALUE_CROP="311x68+848+515"   # Область со значением
#CODE_CROP="120x44+670+526"    # Область с кодом
#VALUE_CROP="311x68+850+516"   # Область со значением
CODE_CROP="120x44+674+406"    # Область с кодом (1.8.0 / 2.8.0)
VALUE_CROP="311x68+929+408"   # Область со значением (крупные цифры)
